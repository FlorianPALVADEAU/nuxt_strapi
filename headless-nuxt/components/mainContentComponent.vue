...
<style lang="scss">
    ...
    .direction-l .flag {
    -webkit-box-shadow: -1px 1px 1px $border-color, 0 0 1px $border-color;
    -moz-box-shadow: -1px 1px 1px $border-color, 0 0 1px $border-color;
    box-shadow: -1px 1px 1px $border-color, 0 0 1px $border-color;
    }
    .direction-r .flag {
    -webkit-box-shadow: 1px 1px 1px $border-color, 0 0 1px $border-color;
    -moz-box-shadow: 1px 1px 1px $border-color, 0 0 1px $border-color;
